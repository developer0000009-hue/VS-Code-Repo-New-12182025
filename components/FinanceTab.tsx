...
import { StatsSkeleton, ListSkeleton } from './common/Skeleton';
                                     ...
                                     <div className="bg-primary/5 border border-primary/20 rounded-[3.5rem] p-12 relative overflow-hidden group shadow-2xl">
                                         ...
                                         <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                                            ...
                                            <button 
                                                ...
                                                className="px-12 py-6 bg-primary text-white font-black text-xs uppercase tracking-[0.4em] rounded-2xl shadow-2xl hover:bg-primary/90 transition-all flex items-center gap-4 active:scale-95 shadow-primary/20 ring-8 ring-primary/5 whitespace-nowrap"
                                            >
                        ...
                        <div className="space-y-16 animate-in fade-in duration-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-12">
                                {feeStructures.map((fs) => (
                                    <div key={fs.id} className="bg-[#0c0d12] border border-white/10 rounded-[4.5rem] p-16 shadow-[0_64px_128px_-24px_rgba(0,0,0,1)] hover:border-primary/40 transition-all duration-1000 flex flex-col h-full group ring-1 ring-white/10 relative overflow-hidden">
