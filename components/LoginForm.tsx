    ...
    return (
        <div className="bg-[#0d0f14]/80 backdrop-blur-3xl p-8 sm:p-12 rounded-[3rem] border border-white/10 space-y-12 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.8)] relative overflow-hidden ring-1 ring-white/5">
            ...
            <div className="text-center space-y-4 relative z-10">
                <h2 className="text-5xl md:text-6xl font-serif font-black text-white tracking-tighter leading-none uppercase">Initialize.</h2>
            ...
            <form onSubmit={handleLogin} className="space-y-6 md:space-y-8 relative z-10">
                ...
                <div className="space-y-3 group">
                    <label className="block text-[10px] font-black text-white/30 uppercase tracking-[0.4em] ml-1 transition-colors group-focus-within:text-primary">Node Identifier</label>
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="block w-full h-[64px] md:h-[72px] pl-14 pr-6 bg-black/40 border border-white/5 rounded-2xl text-sm text-white placeholder:text-white/5 focus:outline-none focus:ring-8 focus:ring-primary/5 focus:border-primary focus:bg-white/[0.03] transition-all duration-500 font-mono font-bold tracking-wider"
                ...
                <div className="space-y-3 group">
                    <div className="flex justify-between items-center ml-1">
                        <label className="block text-[10px] font-black text-white/30 uppercase tracking-[0.4em] transition-colors group-focus-within:text-primary">Secure Cipher</label>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="block w-full h-[64px] md:h-[72px] pl-14 pr-14 bg-black/40 border border-white/5 rounded-2xl text-sm text-white placeholder:text-white/5 focus:outline-none focus:ring-8 focus:ring-primary/5 focus:border-primary focus:bg-white/[0.03] transition-all duration-500 font-mono font-bold tracking-widest"
                            placeholder="••••••••"
                        />
                        <button
                            type="button"
